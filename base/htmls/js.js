...
(function() {
  var Option, Overlay, Popper, Value, js, limit, overlay, queer, root;
  ...
  Popper = (function() {
    ...
    Popper.prototype.add = function(item) {
      this.things.push(new Value('scale', 3));
      this.things.push(new Value('cross section', 'on'));
      return 1;
    };
  ...
  Value = (function() {
    ...
    Value.prototype.build = function() {
      this.element = $("<div class=\"option " + this["class"] + "\">" + this.name + ": <div class=\"value\">" + this.value + "</div></div>");
      return 1;
    };
