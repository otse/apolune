...
const en::Anim ap::anims::walk(nullptr, .1D, false,
		(en::Region[]) {
				{7*26, 0, 26, 34},
				{8*26, 0, 26, 34},
				{9*26, 0, 26, 34},
...
const en::Anim ap::anims::apexconsole(nullptr, .2D, false,
		(en::Region[]) {
				{0, 0, 40, 16},
				{40, 0, 40, 16},
				{40*2, 0, 40, 16},
...
const en::Anim ap::anims::chickenflap(nullptr, .2D, false,
		(en::Region[]) {
				{18, 18, 18, 18},
				{18*2, 18, 18, 18},
				{18*3, 18, 18, 18},
...
const en::Anim ap::anims::chickenrun(nullptr, .2D, false,
		(en::Region[]) {
				{18, 36, 18, 18},
				{18*2, 36, 18, 18},
				{18*3, 36, 18, 18},
...
const en::Anim ap::anims::tentacleblink(nullptr, .1D, false,
		(en::Region[]) {
				{40, 48, 40, 48},
				{40*2, 48, 40, 48},
				{40*3, 48, 40, 48},
...
const en::Anim ap::anims::tentaclemove(nullptr, .125D, false,
		(en::Region[]) {
				{0, 48*3, 40, 48},
				{40, 48*3, 40, 48},
				{40*2, 48*3, 40, 48},
...
const en::Anim ap::anims::tentaclepop(nullptr, .125D, false,
		(en::Region[]) {
				{40,0,40,48},
				{0, 48*2, 40, 48},
				{40, 48*2, 40, 48},
...
const en::Anim ap::anims::fireswirl(nullptr, .075d, false,
		(en::Region[]) {
				{0, 0, 20, 20},
				{20, 0, 20, 20},
				{20*2, 0, 20, 20},
...
const en::Anim ap::anims::spacedust1(nullptr, .05d, false,
		(en::Region[]) {
				{0, 0, 5, 5},
				{5, 0, 5, 5},
				{10, 0, 5, 5},
...
const en::Anim ap::anims::healcloud(nullptr, .15d, false,
		(en::Region[]) {
				{0, 0, 16, 16},
				{16, 0, 16, 16},
				{16*2, 0, 16, 16},
...
const en::Anim ap::anims::playerdeath(nullptr, .075d, false,
		(en::Region[]) {
				{0, 0, 43, 43},
				{43, 0, 43, 43},
				{43*2, 0, 43, 43},
...
const en::Anim ap::anims::sparkle1(nullptr, .05d, false,
		(en::Region[]) {
				{0, 0, 5, 5},
				{5, 0, 5, 5},
				{10, 0, 5, 5},
...
const en::Anim ap::anims::bubbles(nullptr, .1d, false,
		(en::Region[]) {
				{0, 0, 16, 16},
				{16, 0, 16, 16},
				{16*2, 0, 16, 16},
