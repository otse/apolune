...
const Font ap::statfont("stat font", 14, 11, false, gstatfont, lstatfont, textures::statfont);
...
int lbuttonfont = sizeof(gbuttonfont) / sizeof(gbuttonfont[0]);
const Font ap::buttonfont("button font", 14, 11, false, gbuttonfont, lbuttonfont, textures::buttonfont);
